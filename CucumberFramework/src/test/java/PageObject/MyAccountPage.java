package PageObject;
	...
	public class MyAccountPage {
		...
		@FindBy(xpath="//*[@id=\"customer_menu_top\"]/li/a/div[contains(text(),'Rahamthulla')]")	 
		WebElement txtCustomers_name;
		...
		public boolean customersNameExists() {
			boolean flag=txtCustomers_name.getText().contains("Rahamthulla");
			return flag;
		}
